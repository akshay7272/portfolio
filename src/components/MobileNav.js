...
const navigation = [
  ...
  {
    name: "Resume",
    href: "https://drive.google.com/file/d/16HbfVFVLQaDJF9ck0GOf-11x94BSlBEH/view?usp=share_link",
    current: false,
  },
];
...
function Test() {
  return (
    <Disclosure as="nav" className="sm:hidden">
      {({ open }) => (
        <>
          <div className="mx-auto px-2 sm:px-6 lg:px-8 lg:text-sm ">
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3 text-center h-screen">
              {navigation.map((item) => (
                <Link to={item.href}>
                  <Disclosure.Button
                    key={item.name}
